        ...
        <div className="w-[calc(100vw-32px)] sm:w-96 max-w-sm h-[440px] sm:h-[460px] bg-white border border-slate-200 rounded-2xl shadow-2xl flex flex-col overflow-hidden">
          ...
          <div className="p-3 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-xs text-slate-800">Zyn Brainstormer (Free Tier)</span>
            </div>
                ...
                >
                  ...
                  {m.sender === "zyn" && (
                    <button
                      ...
                      className="mt-2 text-[11px] bg-emerald-600 text-white px-2 py-1 rounded font-medium block w-full text-center hover:opacity-90"
                    >
                      🚀 Transfer to Nexa
                    </button>
                  )}
          ...
          <div className="p-2.5 border-t border-slate-200 bg-slate-50 space-y-2">
            ...
            <div className="flex items-center space-x-2">
              ...
              <input
                ...
                className="flex-1 text-xs p-1.5 bg-white border border-slate-200 rounded-lg outline-none focus:border-indigo-600"
              />
              <button
                onClick={handleSendMessage}
                className="bg-slate-900 text-white px-3 py-1.5 rounded-lg text-xs font-semibold hover:opacity-90 active:scale-95 transition-transform"
              >
                Send
              </button>
            </div>
