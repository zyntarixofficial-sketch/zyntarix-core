...
export default function Home() {
  ...
  const sandboxSrcDoc = useMemo(() => {
    ...
    // 1. Clean Imports, Directives and Exports completely
    let sanitizedCode = currentCode
      .replace(/['"]use client['"];?/g, "")
      // Safely strip ALL single-line & multi-line import statements
...
<html>
  ...
  <body>
    ...
    <script>
      // Runtime & Syntax Error Trap (Catch true stack traces)
      ...
      // Lucide Icon Dynamic Universal Fallback Proxy
    ...
    <script type="text/babel" data-presets="react,typescript">
      ...
      // Extract all common Lucide Icon references into local scope safely
      const { 
