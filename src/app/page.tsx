  ...
  const handleStartBuild = async () => {
    ...
    try {
      ...
      if (resData.success && resData.data) {
        ...
        addLog("system", "🚀 Build verified! Interactive Application compiled successfully.", "success");
      ...
      addLog("verifier", `Sentinel Node Alert: ${err.message || "Execution failed"}`, "error");
