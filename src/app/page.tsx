...
export default function Home() {
  ...
  const handleStartBuild = async () => {
    ...
    try {
      ...
      if (resData.success && resData.data) {
        ...
        // Instant Switch to live preview so user immediately sees their app!
  ...
  // 100% Reliable Standalone Live Application Sandbox
  const sandboxSrcDoc = useMemo(() => {
    ...
    // 1. Clean Imports, Directives and Exports
...
<html>
  <head>
    ...
    <!-- Standalone React 18 Production Runtime -->
    <script src="https://unpkg.com/react@18/umd/react.production.min.js"></script>
    <script src="https://unpkg.com/react-dom@18/umd/react-dom.production.min.js"></script>
    <!-- Babel Engine with TypeScript & React Support -->
  ...
  <body>
    ...
    <script>
      // Runtime & Syntax Error Trap (Prevents blank screens)
      window.onerror = function(msg, url, line) {
        var root = document.getElementById('root');
        if (root) {
          root.innerHTML = '<div style="padding:20px;color:#f87171;background:#090d16;height:100vh;font-family:monospace;font-size:12px;"><b>Sandbox Runtime Error:</b><br/>' + msg + '<br/>Line: ' + line + '</div>';
        }
        return true;
      };

      // Lucide Icon Universal Fallback Proxy
      window.UniversalIcon = function(props) {
        ...
        }, React.createElement("circle", { cx: "12", cy: "12", r: "10" }), React.createElement("polygon", { points: "10 8 16 12 10 16 10 8" }));
      };
    ...
    <script type="text/babel" data-presets="react,typescript">
      ...
      // Map Common Lucide Icons to prevent undefined component errors
      const { 
        ...
        Download, BookOpen, Trophy, Flame, Play, Star, Award, Home, Clock, Heart, Menu, CheckCircle, Activity,
        ArrowUp, ArrowDown, ChevronDown, ChevronUp, BarChart2, Eye, EyeOff
      } = window.LucideIcons;
      ...
      try {
        ...
        document.getElementById('root').innerHTML = '<div style="padding:24px;color:#f87171;font-family:monospace;background:#090d16;height:100vh;"><h3>Live Preview Error</h3><pre>' + err.message + '</pre></div>';
      }
    </script>
  </body>
</html>`;
