...
<html>
  <head>
    ...
    <!-- Babel Engine with explicit preset config -->
  ...
  <body>
    ...
    <script>
      // Setup Lucide Icon Universal Fallbacks before compiling
    ...
    <script type="text/babel" data-type="module">
      ...
      try {
        ...
        var AppToRender = typeof GeneratedApp !== 'undefined' ? GeneratedApp : (typeof App !== 'undefined' ? App : null);

        if (AppToRender) {
          const root = ReactDOM.createRoot(document.getElementById('root'));
          root.render(React.createElement(AppToRender));
        } else {
          document.getElementById('root').innerHTML = '<div style="padding:24px;color:#38bdf8;">Application Synthesized. Select components in Code Files.</div>';
        }
      } catch (err) {
        console.error("Live Execution Error:", err);
        document.getElementById('root').innerHTML = '<div style="padding:24px;color:#f87171;font-family:monospace;background:#090d16;height:100vh;"><h3>Live Preview Alert</h3><p>' + err.message + '</p></div>';
      }
    </script>
  </body>
</html>`;
