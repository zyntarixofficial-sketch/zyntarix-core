...
export default function Home() {
  ...
  // Interactive Live UI Patching Handler
  ...
  const sandboxSrcDoc = useMemo(() => {
    ...
    // 1. Extract icons requested from lucide-react before stripping imports
    ...
    // 2. Clean Directives, Imports and Exports
    ...
    // 3. Generate safe declaration string for all extracted icons
...
<html>
  ...
  <body>
    ...
    <script type="text/babel" data-presets="react,typescript">
      ...
      // Safe Icon Variable Mappings
      ${iconDeclarations}

      // Universal Icon Fallbacks
